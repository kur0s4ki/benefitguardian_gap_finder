...
const StateSelector = ({ 
  ...
  const states = [
    { code: 'AL', name: 'Alabama', pensionSystem: 'Teachers\' Retirement System of Alabama' },
    { code: 'AK', name: 'Alaska', pensionSystem: 'Alaska Teachers\' Retirement System' },
    { code: 'AZ', name: 'Arizona', pensionSystem: 'Arizona State Retirement System' },
    { code: 'AR', name: 'Arkansas', pensionSystem: 'Arkansas Teacher Retirement System' },
    { code: 'CA', name: 'California', pensionSystem: 'California State Teachers\' Retirement System' },
    { code: 'CO', name: 'Colorado', pensionSystem: 'Colorado Public Employees\' Retirement Association' },
    { code: 'CT', name: 'Connecticut', pensionSystem: 'Connecticut Teachers\' Retirement System' },
    { code: 'DE', name: 'Delaware', pensionSystem: 'Delaware State Employees\' Pension Plan' },
    { code: 'FL', name: 'Florida', pensionSystem: 'Florida Retirement System' },
    { code: 'GA', name: 'Georgia', pensionSystem: 'Teachers Retirement System of Georgia' },
    ...
    { code: 'IL', name: 'Illinois', pensionSystem: 'Teachers\' Retirement System of Illinois' },
    { code: 'IN', name: 'Indiana', pensionSystem: 'Indiana Teachers\' Retirement Fund' },
    ...
    { code: 'KY', name: 'Kentucky', pensionSystem: 'Kentucky Teachers\' Retirement System' },
    { code: 'LA', name: 'Louisiana', pensionSystem: 'Louisiana Teachers\' Retirement System' },
    ...
    { code: 'MA', name: 'Massachusetts', pensionSystem: 'Massachusetts Teachers\' Retirement System' },
    { code: 'MI', name: 'Michigan', pensionSystem: 'Michigan Public School Employees Retirement System' },
    { code: 'MN', name: 'Minnesota', pensionSystem: 'Teachers Retirement Association of Minnesota' },
    ...
    { code: 'MT', name: 'Montana', pensionSystem: 'Montana Teachers\' Retirement System' },
    ...
    { code: 'NJ', name: 'New Jersey', pensionSystem: 'Teachers\' Pension and Annuity Fund' },
    { code: 'NM', name: 'New Mexico', pensionSystem: 'New Mexico Educational Retirement Board' },
    { code: 'NY', name: 'New York', pensionSystem: 'New York State Teachers\' Retirement System' },
    { code: 'NC', name: 'North Carolina', pensionSystem: 'North Carolina Teachers\' and State Employees\' Retirement System' },
    { code: 'ND', name: 'North Dakota', pensionSystem: 'North Dakota Teachers\' Fund for Retirement' },
    { code: 'OH', name: 'Ohio', pensionSystem: 'State Teachers Retirement System of Ohio' },
    { code: 'OK', name: 'Oklahoma', pensionSystem: 'Oklahoma Teachers\' Retirement System' },
    { code: 'OR', name: 'Oregon', pensionSystem: 'Oregon Public Employees Retirement System' },
    { code: 'PA', name: 'Pennsylvania', pensionSystem: 'Pennsylvania Public School Employees\' Retirement System' },
    { code: 'RI', name: 'Rhode Island', pensionSystem: 'Rhode Island Employees\' Retirement System' },
    { code: 'SC', name: 'South Carolina', pensionSystem: 'South Carolina Retirement System' },
    ...
    { code: 'TX', name: 'Texas', pensionSystem: 'Teacher Retirement System of Texas' },
    { code: 'UT', name: 'Utah', pensionSystem: 'Utah Retirement Systems' },
    { code: 'VT', name: 'Vermont', pensionSystem: 'Vermont State Teachers\' Retirement System' },
    ...
    { code: 'WV', name: 'West Virginia', pensionSystem: 'West Virginia Teachers\' Retirement System' },
