  ...
  const breakdownData = [
    {
      ...
      monthlyContribution: Math.round(
        (userData.pensionGap * 12) / (userData.yearsUntilRetirement * 7)
      ),
      description: `Based on your current pension of $${
        userData.currentPension?.toLocaleString() || "N/A"
      }/month and ${
        userData.yearsOfService
      } years of service, you may face a significant shortfall in retirement income.`,
    ...
    },
    {
      ...
      monthlyContribution: Math.round(
        ((userData.taxTorpedo / 240) * 12) / (userData.yearsUntilRetirement * 7)
      ),
      ...
      methodology: `This calculation analyzes 30% of your current savings ($${
        userData.otherSavings?.toLocaleString() || "0"
      }) as potential tax impact. We model various tax scenarios to identify potential tax bracket jumps and their financial impact.`,
      actionItems: [
    ...
    },
    {
      ...
      monthlyContribution: Math.round(
        (userData.survivorGap * 12) / (userData.yearsUntilRetirement * 7)
      ),
      ...
      methodology: `Our survivor analysis calculates 40% of your monthly pension ($${
        userData.currentPension?.toLocaleString() || "N/A"
      }) as the potential survivor benefit gap. This considers your family's ongoing financial needs and existing coverage.`,
      actionItems: [
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Icon
                    name={
                      expandedSection === item.id ? "ChevronUp" : "ChevronDown"
                    }
                    size={20}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-text-muted">
                      ...
                      Based on moderate growth assumptions over remaining
                      working years
                    </div>
                  </div>
